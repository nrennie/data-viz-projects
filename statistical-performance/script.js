let config = {
    ...
    "colTypes": "tnnnnnnnnnnn", // d = date, n = number, t = text, h = html (not including group and name)
    "iconColumn": ["Income"],
    "circleRadius": 14, // diameter of circle in px
    "colourPalette": ["#7F055F", "#E4BB25", "#197176", "#31AFD4", "#555555"],
    "legend": "custom", // false = no legend, "auto" for just category names
    "legendText": [
        { value: "Low", description: " income: GNI per capita above US $13,935" },
        { value: "Lower middle", description: " income: GNI per capita between US $1,136 and $4,495" },
        { value: "Upper middle", description: " income: GNI per capita between US $4,496 and $13,935" },
        { value: "High", description: " income: GNI per capita above US $13,935" },
    ...
    "filters": ["Income"], // array of column names to filter on, or null for no filters
    "sparklineCols": ["2016", "2024"], // either null, or an array of 2 column names e.g. ["2020", "2023"] giving the inclusive range of columns to render as a single sparkline column instead of printed values
    "sparklineColTitle": "2014-2024 trend", // header title for the sparkline column. Only used if sparklineCols is not null
    "sparklineColour": "#151C28", // stroke/dot colour for the sparkline. Only used if sparklineCols is not null
    "arrowCols": ["Since 2016"], // either null, or an array of column names. For these columns, positive numbers get an up triangle, negative numbers get a down triangle, 0 prints "No change", and missing values print "No data". Column is centre-aligned.
