...
lemur_data <- lemurs |>
  ...
  distinct() |>
  add_row(name = c("Adah", "David"), sex = c("F", "M"))
...
st <- glue("The family tree of white-fronted brown lemurs Adah and David showing 
...
# save image
ggsave("lemur_flowchart.png", width = 6, height = 4, unit = "in")
